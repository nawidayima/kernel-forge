...
| [boundary-tiles](boundary-tiles.md) | Ragged tiles need separate predicates for A loads, B loads, C stores, and unconditional barrier participation | matmul/2_tiled |
